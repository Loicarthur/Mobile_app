...
const ProfileScreen: React.FC<Props> = ({ navigation: { goBack } }) => {
      ...
      <ScrollView>
        <View style={styles.innerContainer}>
          ...
          <View style={styles.profile}>
            ...
            />
            <Text style={styles.profileName}>Loic</Text>
            <Text style={styles.profileEmail}>loic@gmail.com</Text>
            <TouchableOpacity
              onPress={() => {
                // handle onPress
              }}
          ...
          <Text style={styles.contentFooter}> @Copyrigth by F'hire</Text>
        </View>
      </ScrollView>
    </SafeAreaView>
  );
